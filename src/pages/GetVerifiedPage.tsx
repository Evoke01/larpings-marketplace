...
const CheckIcon = () => <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#ff0000]/15 text-[#ff0000]">✓</span>;
...
export default function GetVerifiedPage() {
  ...
  return <div className="mx-auto w-full max-w-[1152px] px-4 pb-16 pt-12">
    ...
    <section className="mt-12 grid gap-4 md:grid-cols-3"><Feature title="A clear trust signal" text="Verified ownership appears directly on the listing after the challenge is complete." icon={<ShieldIcon />} /><Feature title="Your account stays private" text="We never ask for platform credentials. Only a temporary code in your larpings bio is checked." icon={<span className="text-xl">✦</span>} /><Feature title="Works per listing" text="Verify the specific username you control. Keep other listings unverified until you are ready." icon={<span className="text-xl">◎</span>} /></section>
